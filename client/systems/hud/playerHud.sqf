...
while {true} do
{
    ...
    _vitals ctrlSetStructuredText parseText format ["%1 <img size='1' image='client\icons\1.paa'/><br/>%2 <img size='1' image='client\icons\money.paa'/>", _health, (player getVariable "cmoney")];
